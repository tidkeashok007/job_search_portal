...
@push('title')
<title>Admin - Employer_req</title>
@endpush

@push('pannelname')
<h3>Employer Request's</h3>
@endpush
...
@push('ul')
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a href="{{url('admin_employer_req')}}" class="nav-link menu-link active"> <i class="bi bi-person-video3"></i> <span data-key="t-email">Employer Request's</span> </a>
        </li>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-3 text-center">Request's</h4>
                                </div><!-- end card header -->
                                        ...
                                        <table class="table align-middle table-nowrap mb-0">
                                            ...
                                            @foreach ($employers as $employer)
                                                <tr>
                                                    ...
                                                    <td>
                                                    <form method="post" action="{{route('employee_Approve')}}">
                                                        @csrf
