...
@push('title')
<title>Admin - Employer_dtl</title>
@endpush

@push('pannelname')
<h3>Employer Detail's</h3>
@endpush
...
@push('ul')
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a href="{{url('admin_employer_dtl')}}" class="nav-link menu-link active"> <i class="bi bi-person-vcard"></i> <span data-key="t-email">Employer Detail's</span> </a>
        </li>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-3 text-center">Active Employer</h4>
                                </div><!-- end card header -->
