...
@push('ul')
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a href="{{route('employeedashboard')}}" class="nav-link menu-link collapsed" role="button" aria-controls="sidebarDashboards">
                <i class="ph-gauge"></i> <span data-key="t-dashboards">Users Dashboards</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a href="{{route('employee_about')}}" class="nav-link menu-link active"> <i class="bi bi-globe2"></i> <span data-key="t-email">About</span> </a>
        </li>
