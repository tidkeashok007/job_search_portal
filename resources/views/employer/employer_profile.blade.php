...
@push('ul')
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a href="{{route('employer_about')}}" class="nav-link menu-link"> <i class="bi bi-envelope-plus"></i> <span data-key="t-email">Contact</span> </a>
        </li>
        ...
        <li class="nav-item">
            <a href="{{route('employer_profile')}}" class="nav-link menu-link active"> <i class="bi bi-person-circle"></i> <span data-key="t-email">Profile</span> </a>
        </li>
